...
//    m_menus[OpenGameMenu]->add(make_unique<MusicButton>(musicIcons, Vector2f(1400, 0), SoundButtonRect));
    m_menus[OpenGameMenu]->add(make_unique<MusicButton>(musicIcons, Vector2f(1400, 0), SoundButtonRect2));
...
void Gui::mouseEventMoved(sf::RenderWindow &window, const Event &event) {
